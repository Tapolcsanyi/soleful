    ...
    return (
        <>
            ...
            <h3>Edit Sneaker</h3>
                ...
                <button type="button" onClick={handleConfirm} className="sneakerButton2">Save</button>
                <button className="sneakerButton2" variant="secondary" onClick={() => history.push("/")}>Cancel</button>
                </fieldset>
            </form>
        </>
    );
